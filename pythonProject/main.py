...
verb5 = input("Type an VERB and press ENTER. ")
verb6 = input("Type an VERB and press ENTER. ")
verb7 = input("Type an VERB and press ENTER. ")
verb8 = input("Type an VERB and press ENTER. ")
verb9 = input("Type an VERB and press ENTER. ")
verb10 = input("Type an VERB and press ENTER. ")
verb11 = input("Type an VERB and press ENTER. ")
